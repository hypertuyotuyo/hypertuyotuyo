(function () {
  ...
  const T = {
    ja: {
      ...
      'gl.ai.c2.note':   '生成結果をそのまま素材として使うのではなく、作品のクオリティを上げるための補助（サポート）として使用するAIに限ります。（アップスケール・ブラッシュアップ・色調補正の支援 など）',
    ...
    en: {
      ...
      'gl.ai.c2.note':   'Limited to AI used as assistance to raise the quality of a work, rather than using its generated output directly as an asset (e.g., upscaling, brush-up, and color-correction assistance).',
