(function () {
  ...
  const T = {
    ja: {
      ...
      'gl.ai.c2.note2':  '※ 学習元がスクレイピングではなく、権利的に問題のない学習セットであると明言されているものに限ります。学習元が不透明で著作権が判断できないもの（上記「再現性がなく著作権が不透明なもの」）とは区別しています。',
    ...
    en: {
      ...
      'gl.ai.c2.note2':  '※ Limited to cases where the training source is explicitly stated to be a legitimate dataset rather than scraped data. This is distinguished from cases where the training source is opaque and copyright cannot be assessed (see "Non-reproducible and copyright-unclear" above).',
