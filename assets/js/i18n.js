(function () {
  ...
  const T = {
    ja: {
      ...
      'gl.ai.c3.note':   'イラスト・商品画像のロゴ・背景画像・3Dモデル・動画・効果音・ボイス・BGM・音楽・フォント・意訳や物語性のあるテキストなど個人の創造性に依存するもの など',
    ...
    en: {
      ...
      'gl.ai.c3.note':   'Illustrations, product logos, background images, 3D models, video, sound effects, voices, BGM, music, fonts, paraphrased or narrative text dependent on individual creativity, etc.',
